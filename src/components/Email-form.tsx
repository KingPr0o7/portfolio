	...
	return (
		<form id="contact-form" onSubmit={handleSubmit}>
			...
			<div className="contact-input">
				...
				<textarea className="form-textarea" id="contact-message" name="input" required placeholder='"And blood-black nothingness began to spin — a system of cells interlinked within, cells interlinked within cells interlinked, within one stem. — And dreadfully distinct, against the dark, a tall white fountain played." - Vladimir Nabokov, Pale Fire qtd. in Blade Runner 2049'></textarea>
			</div>
